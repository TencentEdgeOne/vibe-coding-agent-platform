...
import { wrapSandboxTools } from './tools/commands-wrap.ts';
import { wrapWebSearchTool } from './tools/web-search-wrap.ts';
import {
...
import { buildLoadMakersSkillTool } from './tools/makers-skills.ts';
import { buildPrompt, buildTurnPrompt } from './prompt.ts';
import { resolveMakersProjectName } from './project/makers-deploy.ts';
import type {
  AgentProgressEvent,
  CodingAgentResult,
  ConversationMessage,
...
import { summarizeToolInput, summarizeToolOutput } from './utils/activity.ts';
import {
  resolveNarrationEmit,
  sanitizeNarrationText,
  type NarrationEmitState,
} from './utils/narration.ts';
import {
  isInstallCommand,
