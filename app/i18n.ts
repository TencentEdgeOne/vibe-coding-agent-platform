...
export const TRANSLATIONS = {
  zh: {
    ...
    workspace: {
      ...
      gatewayPromptTitle: '启用 AI 对话',
      gatewayPromptDescription: '添加 Models API 密钥，即可在预览中试用对话。密钥只保存在此项目中，无需登录。',
      gatewayPromptDeployHint: '发布到线上后，站点仍需使用这把密钥。',
      gatewayPromptDocs: '如何获取密钥',
      gatewayPromptApiKey: 'API 密钥',
      gatewayPromptContinue: '添加',
      gatewayPromptSkip: '稍后',
      gatewayPromptChip: '添加 API 密钥',
      gatewayPromptSaved: '已添加，可以在预览中试用对话。',
      preview: '预览',
      code: '代码',
  ...
  en: {
    ...
    workspace: {
      ...
      gatewayPromptTitle: 'Enable AI chat',
      gatewayPromptDescription: "Add a Models API key to try the conversation in Preview. It stays with this project — there's no account.",
      gatewayPromptDeployHint: 'A published site needs this key too.',
      gatewayPromptDocs: 'How to get a key',
      gatewayPromptApiKey: 'API Key',
      gatewayPromptContinue: 'Add',
      gatewayPromptSkip: 'Not Now',
      gatewayPromptChip: 'Add API Key',
      gatewayPromptSaved: 'Added. You can try the chat in Preview.',
      preview: 'Preview',
      code: 'Code',
      session: 'Session',
      ...
      prepStages: {
        conversation: 'Creating the conversation…',
        sandbox: 'Starting the sandbox…',
        agent: 'Waking the coding agent…',
        workspace: 'Restoring project files…',
